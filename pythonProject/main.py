...
# SMB2 Write Request Structure Constants
STRUCTURE_SIZE = 49            # Size of the request structure (excluding header)
CHANNEL_NONE = 0               # SMB2_CHANNEL_NONE
...
if __name__ == "__main__":
    ...
    data_to_write = b"StructureSize (2 bytes),DataOffset (2 bytes),Length (4 bytes),Offset (8 bytes),FileId (16 bytes),Channel (4 bytes)"  # Replace with actual data to write
